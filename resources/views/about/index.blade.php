        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="{{ asset('assets/client/images/blog_1.jpg')}}" alt="Image placeholder"
            ...
            <div class="row">
                    ...
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('assets/client/images/person_1.jpg')}}" alt="Image placeholder"
                                     class="mb-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('assets/client/images/person_2.jpg')}}" alt="Image placeholder"
                                     class="mb-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('assets/client/images/person_3.jpg')}}" alt="Image placeholder"
                                     class="mb-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('assets/client/images/person_4.jpg')}}" alt="Image placeholder"
                                     class="mb-4">
